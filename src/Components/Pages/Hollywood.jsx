...
import { hollyData } from "../Data/HollyData";
...
function Hollywood() {
  ...
  let myhollyData = hollyData.slice(startIndex, endIndex);
  let endPage = Math.ceil(hollyData.length / page_size);
  let prePage = () => {
